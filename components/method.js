...
export default class Method extends Component {
  ...
  render() {
    ...
    const methodTitle = method.details ||
      (contract.structure.constantFunctions[method.name] ? contract.structure.constantFunctions[method.name].title : '')
    const methodDescription = method.notice||
      (contract.structure.constantFunctions[method.name] ? contract.structure.constantFunctions[method.name].description : '')
    ...
    return (
      <Segment color={color}>
        ...
        {methodTitle && <ReactMarkdown containerTagName="h4" source={methodTitle}/>}
        {methodDescription && <ReactMarkdown source={methodDescription}/>}
